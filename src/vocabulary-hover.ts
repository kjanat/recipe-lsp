...
const UNIT_KINDS: ReadonlyArray<{ set: readonly string[]; info: HoverInfo }> = [
	...
	{
		set: ACTIVITY,
		info: hover("Activity unit", "Recognized as a biological activity dose unit."),
	},
	{
		set: COUNTABLE,
		info: hover("Countable unit", "Recognized as a discrete count-based unit."),
	},
];
...
const NODE_HOVER_INFO = new Map<string, HoverInfo>([
	...
	[
		"dispense_marker",
		hover("Dispense marker", "Starts the pharmacist dispense section (`Da/` or `D/`)."),
	],
	["signa_marker", hover("Signa marker", "Starts the patient directions section (`S/`).")],
	[
		"frequency",
		hover("Compact frequency", "Recognized compact dosing frequency like `1 dd` or `3dd`."),
	],
	[
		"frequency_abbrev",
		hover("Frequency abbreviation", "Recognized Latin-style frequency abbreviation."),
	],
	["timing_abbrev", hover("Timing abbreviation", "Recognized timing abbreviation.")],
	[
		"route_abbrev",
		hover("Route abbreviation", "Recognized administration-route abbreviation."),
	],
	[
		"dispensing_abbrev",
		hover("Dispensing abbreviation", "Recognized pharmacist dispensing abbreviation."),
	],
	...
	[
		"compounding_abbrev",
		hover("Compounding abbreviation", "Recognized compounding abbreviation."),
	],
	[
		"conditional_abbrev",
		hover("Conditional abbreviation", "Recognized conditional abbreviation."),
	],
	[
		"fill_marker",
		hover("Fill-to marker", "`ad` marker used in fill-to-total directives like `ad 100 g`."),
	],
	[
		"dtd_keyword",
		hover("Dispense-count directive", "`dtd` / `d.t.d.` directive for dispense counts."),
	],
	[
		"dtd_no",
		hover("Dispense-count literal", "Literal `no` inside a `dtd` directive."),
	],
